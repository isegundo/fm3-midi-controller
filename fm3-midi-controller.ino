...
ezButton button8(8);
ezButton button9(9);  // create ezButton object that attach to pin 9;
...
void loop() {
  ...
  //int btnState8 = button8.getState();
  //    int btnState9 = button9.getState();
  ...
  if (state8 && state9 && !configSet) {
    configSet = true;
    Serial.println("The button 8 and 9 are pressed");
  ...
  if (button9.isReleased()) {
    Serial.println("The button 9 is released");
    state9 = false;
    configSet = false;
  }
